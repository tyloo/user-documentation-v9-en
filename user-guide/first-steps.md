...
Deactivating your shop means making sure that no one can access it while you are busy making changes, creating products, settings prices and taxes, installing payment modules and a new theme, setting carriers... This is called "putting your store in maintenance mode".
...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Store name             | Defines your brand, most notably on search engines (Google, Yahoo!, Bing...).                                                                                                                                                                                                                                                     | "Shop Parameters" menu, "Contact" page, "Stores" tab, then in the "Contact details" section, edit the "Store name" option.                                                                                                                                                                                                                                           |
| Store logo             | <p>Defines your brand visually. The default logo says "Classic", which is the name of the default theme.<br>Displayed at the top left of every page of your store, as well as in your invoices and other automatic e-mails.</p>                                                                                                   | "Design" menu, "Theme & Logo" page, "Your current theme" section, then change the various default images to your logo.                                                                                                                                                                                                                                               |
| Default store currency | The currency in which you want to set the default price for your products.                                                                                                                                                                                                                                                        | <p>"International" menu, "Localization" page, "Configuration" section.<br>If the currency is not available, you must import a localization pack for its country first: use the "Import a localization pack" tool from the same page.</p>                                                                                                                             |
| Store information      | Several blocks presenting the phone number for your store, your contact address and the email for your store. These are displayed at various places in the front-offices.                                                                                                                                                         | <p>The information comes from "Shop Parameters" menu, "Contact" page, "Stores" tab, then in the "Contact details" section.</p><p>To disable it, refer to the "Contact information" module.</p>                                                                                                                                                                       |
...
| Reassurance            | On the product page, a block allows you to display some reassurance details. Use it to give some details about your return policy ("Free returns!"), your security policy ("Secured payments"), etc., so that visitors will feel it's safe to order from your store.                                                              | "Customer reassurance" module.                                                                                                                                                                                                                                                                                                                                       |
...
The product page is functioning a bit differently. You won't find a language selector for each text field, but rather a general language selector at the top of the page. Once you've selected a language you can then change all the contents in this language. Make sure you're editing the right one!
...
You can install and enable many languages if you think your store needs them, but be aware that you will have to translate your content for all of the enabled languages: product names, descriptions, tags, category names and descriptions, static content (pages), module settings, etc.
...
Now that you have a proper account for this employee, you should give that account specific permissions, tailored to the employee's tasks. By default, a new profile cannot do much. It is up to you to set exactly the parts of your store to which that profile should have access. It can be a tedious task, but it is an important one.\
...
* **Enable Store**: set it back to "Yes".
* **Maintenance IP**: remove your IP from the list. This is optional: your store will still work if you leave the field as it is.

Your store should now be fully ready to receive its first visitors... and take its first orders!
